...
- MCP Server (11 工具: scan/summary/datasets/github/papers/blogs/config/search/diff/trend/history)
- Claude Code Skills (7 个: scan/brief/search/diff/deep-dive/recipe/radar)
- radar_search 全文搜索 (跨 5 类数据源, 支持正则, 按来源过滤)
...
- 监控源大扩展 (HF 86 orgs, GitHub 50 orgs, arXiv +cs.CV/cs.RO, X 125 账户, 博客 71 源)
...
- Web 可视化仪表盘 (`/dashboard`: 5 视图, Chart.js, 深色主题)
