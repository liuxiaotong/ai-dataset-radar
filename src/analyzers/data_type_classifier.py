...
CLASSIFICATION_RULES = {
    ...
    DataType.CODE: {
        ...
        "name_patterns": [r"code", r"prog", r"exec", r"python", r"coding", r"verus", r"verif"],
    ...
    DataType.MULTIMODAL: {
        ...
        "name_patterns": [
            r"vision", r"image", r"video", r"vlm", r"vqa", r"visual", r"molmo",
            r"audio", r"speech", r"doc[-_]", r"clip[-_]",
        ],
        "tags": [
            "multimodal", "vision", "image", "video", "vqa",
            "audio", "document_understanding", "document_comprehension",
            "document_classification", "document_segmentation",
        ],
    },
    ...
    DataType.EVALUATION: {
        ...
        "name_patterns": [r"bench", r"eval", r"test", r"assess", r"guard", r"safety"],
